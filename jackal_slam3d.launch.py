...
#
#   3) Launch SLAM:
#     $ ros2 launch rtabmap_demos jackal_slam3d.launch.py use_sim_time:=true
#
#   4) Launch nav2"
...
def generate_launch_description():
    ...
    icp_odom_parameters={
        #   'map_frame_id':'map',
          ...
          'guess_frame_id':'odom',
          'OdomF2M/ScanSubtractRadius': '0.12', # match voxel size
    ...
    shared_parameters={
          ...
          'Mem/NotLinkedNodesKept':'false',
          'Icp/VoxelSize': '0.1',
          'Icp/MaxCorrespondenceDistance': '1.4', # roughly 10x voxel size
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            'robot_ns', default_value='j100_0029',
